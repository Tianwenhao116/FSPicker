...
class rsaBlock(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        '''
        这三行代码分别实例化了三个不同的空间注意力块，分别对应于医学图像中的冠状面、矢状面和轴向
        '''
        ...
        '''
        这三行代码创建了三个可学习的参数 coronal_beta、sagittal_beta 和 axial_beta，它们是网络中的超参数，用于控制不同空间注意力块对最终输出的贡献。
        '''
        ...
        '''
        这两行代码将空间注意力块和对应的 Beta 参数分别添加到 ModuleList 和 ParameterList 中。这样，它们就可以在神经网络的训练过程中被自动处理
        '''
